...
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mercado Livre (link `meli.la` por produto não cabe no modelo atual) e Netshoes/Rakuten (painel indisponível) ainda sem monetização real ativa (ver §3.1) | Médio      | Não é bug — Mercado Livre precisa de decisão de arquitetura (campo por-oferta, não `affiliateBaseUrl` por loja); Netshoes/Rakuten depende do suporte resolver o painel; `/admin/monetizacao` mostra isso honestamente |
