...
| Afiliados           | 🟡 em andamento, 3 lojas em estágios distintos — ver §3.1 | Amazon ativo (`tag=suplescore-20`), fiscal enviado (questionário `Completo`, retenção `0.0%`, tela da conta mostra `Enviado`), aguardando revisão da Amazon (3–5 dias úteis); Mercado Livre ativo e com clique real registrado, mas o link do botão "Compartilhar" ainda não foi validado como formato oficial de afiliado; Netshoes/Rakuten com campanha aparentemente ativa, painel com problema de interação, suporte acionado |
