...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "bg-bg-muted text-text-muted inline-flex h-10 items-center justify-center rounded-md p-1",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 focus-visible:ring-2 focus-visible:ring-(--color-focus-ring) focus-visible:outline-none",
      className,
    )}
    {...props}
  />
