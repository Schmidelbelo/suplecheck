...
const criteria = [
  { label: "Pureza da composição", value: 92 },
  { label: "Dosagem por porção", value: 88 },
  { label: "Transparência do rótulo", value: 95 },
  { label: "Custo-benefício", value: 81 },
];
      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div className="flex flex-col gap-5">
          ...
          <p className="text-text-muted text-lg">
            ...
            resume quatro critérios objetivos em uma nota de 0 a 100 — quanto maior, melhor o
            produto se posiciona na categoria.
          </p>
              ...
              {criteria.map((criterion) => (
                <div key={criterion.label} className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-text font-medium">{criterion.value}</span>
                  </div>
