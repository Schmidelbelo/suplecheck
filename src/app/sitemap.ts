...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: {
    ...
    { path: "/confianca", priority: 0.6, changeFrequency: "monthly" },
    { path: "/missao", priority: 0.5, changeFrequency: "monthly" },
    { path: "/politica-editorial", priority: 0.4, changeFrequency: "monthly" },
    { path: "/politica-de-correcoes", priority: 0.4, changeFrequency: "monthly" },
    { path: "/fontes", priority: 0.4, changeFrequency: "monthly" },
    { path: "/independencia-editorial", priority: 0.4, changeFrequency: "monthly" },
    { path: "/aviso-medico", priority: 0.4, changeFrequency: "monthly" },
