...
export const metadata: Metadata = buildMetadata({
  title: "Termos de Uso",
  description: "Condições de uso da plataforma SupleCheck.",
  path: "/termos",
});
...
const sections: LegalSection[] = [
  {
    ...
    body: (
      <p>
        Ao acessar o SupleCheck, você concorda com estes Termos de Uso. Se não concordar com alguma
  ...
  },
  {
    ...
    body: (
      <p>
        O SupleCheck é uma plataforma de comparação e conteúdo informativo. Não somos uma farmácia,
  ...
  },
  {
    ...
    body: (
      <ul className="flex flex-col gap-2">
        ...
        <li>Compartilhar links e trechos do conteúdo, com atribuição ao SupleCheck;</li>
        <li>
  ...
  },
  {
    ...
    body: (
      <p>
        Alguns links para lojas parceiras podem gerar comissão ao SupleCheck sem custo adicional
