...
const staticRoutes = [
  ...
  { path: "/creatina/melhor-custo-beneficio", priority: "0.7", changefreq: "weekly" },
  { path: "/creatina/menor-preco-por-dose", priority: "0.7", changefreq: "weekly" },
  { path: "/creatina/mais-vendidos", priority: "0.7", changefreq: "weekly" },
  { path: "/creatina/mais-bem-avaliados", priority: "0.7", changefreq: "weekly" },
