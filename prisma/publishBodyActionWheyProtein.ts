...
const PRODUCT_SLUG = "bodyaction-body-whey-protein-900g";
const STORE = { slug: "bodyaction-oficial", name: "Loja Oficial BodyAction" } as const;
const PRICE = {
  priceCents: 7360,
  url: "https://www.bodyaction.com.br/linha-completa/body-whey-900g",
  ...
  await container.useCases.evaluateSupplement.execute({
    ...
    facts: {
      ...
      pricing: {
        ...
        dosesPerUnit: sku.servingsPerUnit ?? 22,
