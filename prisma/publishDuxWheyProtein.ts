...
const PRODUCT_SLUG = "dux-whey-protein-concentrado-900g";
const STORE = { slug: "fastfit-suplementos", name: "Fast Fit Suplementos" } as const;
const PRICE = {
  priceCents: 24990,
  url: "https://www.fastfitsuplementos.com.br/wpc900gdux",
