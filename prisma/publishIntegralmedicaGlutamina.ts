...
/**
 * Sprint de Crescimento — Glutamina (categoria nova). Integralmédica
 * Glutamine Isolates 300g — composição confirmada de forma consistente:
 * 5g de glutamina por dose (1 dosador). Preço real da Amazon.
 * Nenhuma metodologia dedicada existe para Glutamina — reaproveita
 * "creatina-methodology".
 */

const CATEGORY = { slug: "glutamina", name: "Glutamina" } as const;

const PRODUCT = {
  slug: "integralmedica-glutamina-300g",
  name: "Integralmédica Glutamine Isolates 300g",
  variantLabel: "300g",
  glutaminePerDoseGrams: 5,
  servingsPerUnit: 60, // 300g / 5g = 60 doses
  ingredientsText: "L-glutamina 100% pura isolada, sem sabor, sem gordura, sem carboidrato.",
  sourceUrl: "https://www.integralmedica.com.br/aminoacidos/glutamina",
} as const;

const PRICE = {
  storeSlug: "amazon-br",
  priceCents: 4463,
  url: "https://www.amazon.com.br/Glutamina-Natural-Isolada-Recupera%C3%A7%C3%A3o-P%C3%B3s-Treino/dp/B07L5X6FSQ",
